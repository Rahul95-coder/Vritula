        ...
        <div className="pt-20">
            ...
            <section className="hero-gradient text-white pt-24 pb-20">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    <h1 className="text-3xl md:text-5xl font-bold hero-title">Build Reliable Solutions with Confidence</h1>
                    <p className="mt-6 max-w-2xl mx-auto text-lg opacity-90">
                        Vritula delivers powerful, scalable digital products and cloud-ready solutions for modern businesses.
                    </p>

                    <div className="mt-8 flex justify-center gap-4">
                        <a href="/products" className="brand-btn">Explore Products</a>
                        <a href="/contact" className="inline-flex items-center justify-center px-5 py-3 rounded-lg border border-white/30 hover:bg-white/10 transition">
                            Contact Sales
                        </a>
                    </div>
                </div>
            ...
            <section className="py-20 bg-white">
                <div className="max-w-7xl mx-auto px-4">
                    <div className="text-center mb-12">
                        ...
                        <p className="text-gray-600 mt-2">Enterprise-ready tools that help teams ship faster and safer.</p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <article className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition">
                            ...
                            <p className="mt-2 text-gray-600">Fast, optimized and robust systems with production-grade reliability.</p>
                        </article>

                        <article className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition">
                            <img src="/icons/cloud.svg" alt="" className="w-12 h-12 mb-4" />
                            <h3 className="font-semibold text-lg">Cloud Native</h3>
                            <p className="mt-2 text-gray-600">Designed to scale on major cloud providers with secure deployments.</p>
                        </article>

                        <article className="bg-gray-50 p-8 rounded-xl shadow-sm hover:shadow-md transition">
                            <img src="/icons/security.svg" alt="" className="w-12 h-12 mb-4" />
                            <h3 className="font-semibold text-lg">Security First</h3>
                            <p className="mt-2 text-gray-600">Built-in best practices and secure-by-default architecture.</p>
                        </article>
                    </div>
                </div>
            </section>
